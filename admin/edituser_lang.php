...
$l['slave_cant'] = 'Edit Users Error';
$l['slave_cant_exp'] = 'Slave servers are not allowed to edit users !';
$l['no_type'] = 'Please specify the user type';
...
$l['new_email'] = 'Email';
$l['change_email'] = 'The email address of this user';
$l['new_pass'] = 'New Password';
$l['changepass'] = 'Leave blank if you do not want to change the password';
$l['sub_but'] = 'Edit user';
$l['user_1'] = 'Admin';
$l['user_2'] = 'Cloud';
$l['user_0'] = 'User';
